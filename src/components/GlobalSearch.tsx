  ...
  return (
    <>
      <button
        ...
        className="flex h-10 w-full max-w-xl items-center gap-2 rounded-lg border bg-background px-3 text-sm text-muted-foreground shadow-sm transition hover:bg-accent"
      >
        <Search className="h-4 w-4" />
        <span className="truncate">Cari klien, penawaran, faktur...</span>
